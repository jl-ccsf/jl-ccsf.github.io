...
For guidelines on appropriate behavior and communication, please see the [Code of Conduct](/CODE_OF_CONDUCT.md "Root file").
...
- **Validation:**
  ...
  - [HTML Validator](https://validator.w3.org/ "W3.org") by W3C

  - [CSS Validator](https://jigsaw.w3.org/css-validator/ "W3.org") by W3C

  - [Accessibility Validator](https://www.accessibilitychecker.org/ "AccessibilityChecker.org") by Accessibility Checker

- **Conversion:**

  - [Px-to-Rem Converter](https://nekocalc.com/px-to-rem-converter "NekoCalc.com") by NekoCalc
  
- **Compression:**

  - [HTML Minifier](https://www.w3schools.com/tools/tool_html_formatter.php "W3Schools Tools") by W3Schools

  - [CSS Minifier](https://www.w3schools.com/tools/tool_css_minifier.php "W3Schools Tools") by W3Schools

\**AI tools disabled*

## Attribution

All files are my own work. **No AI was used at any point in my creation process. I do not consent to AI using my content.** Please do not plagiarize my work. Guidelines for appropriate usage and sharing can be found in the [License](/LICENSE.md "Root file").
